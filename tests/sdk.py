...
with tempfile.TemporaryDirectory() as tmp:
    ...
    call('new',package,id,'Author example');original=(package/'widget.json').read_text()
    call('new',package,id,'Do not overwrite',ok=False);assert (package/'widget.json').read_text()==original
