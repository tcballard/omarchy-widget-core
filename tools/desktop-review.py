...
CHECKS = {
    ...
    'lifecycle': 'Separate shell process; kill/stop/restart Core; all descendants cleaned; sibling package survives runner failure.',
...
def suite(worldclock=None, older_core=None, proxy=None):
    ...
    no_helper = ['qml_smoke', 'lifecycle', 'preview_contract', 'installer', 'keybinding', 'sandbox']
